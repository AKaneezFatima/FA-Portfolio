    ...
    <form>
        ...
        <div className='mb-3'>
            <input
                ...
                name='name'
                className='w-[400px] px-3 py-2 text-sm text-gray-800 placeholder-gray-400 bg-white border-0 rounded shadow'
            />
        </div>
        <div className='mb-3'>
            <input
                ...
                name='email'
                className='w-[400px] px-3 py-2 text-sm text-gray-800 placeholder-gray-00 bg-white border-0 rounded shadow'
            />
        </div>
        <div className='mb-3'>
            <input
